...
"""
### add  return the recall, precision and f1 for test_classifier
    ...
    for train_idx, test_idx in cv: 
        ...
        for prediction, truth in zip(predictions, labels_test):
            if prediction == 0 and truth == 0:
                ...
                true_positives += 1
    precision, recall,f1,f2 =0, 0,0,0
...
def main():
    ...
    ### Run testing script
    a,b = test_classifier(clf, dataset, feature_list)
    print a,b
